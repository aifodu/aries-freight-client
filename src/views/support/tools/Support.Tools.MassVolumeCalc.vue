<template>
    <div class="service">
        ...
        <div class="container pd-x-30 lh-2">
            ...
            <div>
                <p>You may choose to ship your package by volume instead of weight. This
                    is beneficial because you can fit as much as you are able into the same box and pay a flat rate to
                    have it shipped. With the Mass and Volume Calculator you can do it in a few simple steps.</p>
                <div class="full mt-2">
                    <div class="half">
                    ...
                    <div class="half">
                        ...
                        <h2 v-bind:class="{'old': (errors.has('length') || errors.has('width') ||
                                    errors.has('height'))}">
                            <small>Volume =</small> {{computedVolume}}
                        </h2>
                    </div>
                </div>
            </div>
...
<style scoped>
    ...
    .service .mass-volume {
        background: url("../../../assets/images/background/support/tools/mass-volume.jpg") no-repeat fixed center;
