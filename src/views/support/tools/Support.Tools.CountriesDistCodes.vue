<template>
    <div class="service">
        <div class="container">
            <div class="sub-page-header countries-dist-codes">
                <div class="overlay">
                    <h1>Countries Distances and Codes</h1>
                </div>
            </div>
        </div>
        <div class="container pd-x-30 lh-2">
            ...
            <div>
                <p>The volumetric weight of a shipment is a calculation that reflects the density of a package.
                    ...
                    weight of the shipment to ascertain which is greater; the higher weight is used to calculate
                    the shipment cost.</p>
                <div class="full mt-2">
                    <div class="half">
...
<style scoped>
    ...
    .service .countries-dist-codes {
        background: url("../../../assets/images/background/support/tools/state-map.jpg") no-repeat fixed center;
